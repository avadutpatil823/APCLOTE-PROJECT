...
public class UserRestController {
	...
	public ResponseEntity<Page<Batch>> getAllBatchs(@RequestParam int pageNumber,@RequestParam int pageSize){
		Page<Batch> batches = userService.getAllBatches(pageNumber-1,pageSize);
...
//		payment.getPurchaseOrder().setBatch(batch);
  ...
  public ResponseEntity<String> verifyOtp(@RequestBody Map<String, String> request) {
      ...
      if (isValid) return ResponseEntity.ok("OTP verified successfully");
