...
public class LecturerController {
	...
	public ResponseEntity<String> uploadClassVideo(@RequestParam("file")MultipartFile file,@RequestParam("title")String title,@RequestParam("classId") Long classId) throws IOException{
	...
	public ResponseEntity<String> uploadClassNotes(@RequestParam("file")MultipartFile file,@RequestParam("title")String title,@RequestParam("classId") Long classId) throws IOException{
