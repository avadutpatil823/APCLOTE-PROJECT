    ...
    <div className="dashboard-card overflow-hidden">
      <div className="bg-[linear-gradient(135deg,#4f46e5,#06b6d4)] text-white py-5 px-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold font-['Space_Grotesk']">{batch.name}</h2>
            <p className="text-sm text-sky-50/90 mt-1">{batch.course?.name}</p>
          </div>
          <span className="pill-tag bg-white/12! text-white!">
      ...
      <div className="p-6 space-y-4 text-slate-700">
        ...
        <div className="flex items-center gap-3">
          ...
          <p>
            <strong>Timing:</strong> {batch.start_time} - {batch.end_time}
          </p>
        </div>
