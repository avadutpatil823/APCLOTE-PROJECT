    ...
    <footer className="bg-gray-900 text-gray-100">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand / About */}
          <div>
            <h3 className="text-2xl font-extrabold tracking-tight">APCLOTE</h3>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="mt-4 flex flex-col sm:flex-row gap-3">
              ...
              <input
                ...
                className="w-full sm:w-auto flex-1 min-w-0 px-3 py-2 rounded bg-gray-800 border border-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
