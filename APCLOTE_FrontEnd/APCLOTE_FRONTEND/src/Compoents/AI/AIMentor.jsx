...
const readStoredMentorSession = () => {
  ...
  try {
    ...
    console.debug("Unable to restore mentor session history:", error);
    return null;
  }
};
...
const AIMentor = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.debug("Unable to persist mentor session history:", error);
    }
...
const location = useLocation();
  ...
  const stopRecognition = () => {
    ...
    try {
      ...
      console.debug("Recognition stop skipped:", err);
    }
  };
  ...
  return (
    <Box
      className="w-full px-3 py-4 sm:px-5"
      sx={{
        minHeight: "calc(100dvh - var(--app-navbar-height))",
        background:
          "radial-gradient(circle at top left, rgba(56,189,248,0.16), transparent 28%), radial-gradient(circle at top right, rgba(16,185,129,0.14), transparent 26%), linear-gradient(135deg, #020617 0%, #0f172a 52%, #111827 100%)",
      }}
    >
      <Box
        className="mx-auto max-w-7xl overflow-hidden rounded-[24px] border border-white/10"
        sx={{
          display: "grid",
          gridTemplateColumns: {
            xs: "1fr",
          ...
          height: {
            xs: "auto",
            xl: "calc(100dvh - var(--app-navbar-height) - 64px)",
          },
          minHeight: {
          ...
          boxShadow: `0 34px 80px ${alpha("#020617", 0.48)}`,
        }}
      >
        <Box
          className="hidden min-h-0 overflow-y-auto border-r border-white/10 xl:block"
          sx={{
            background: `linear-gradient(180deg, ${alpha("#082f49", 0.82)} 0%, ${alpha(
              "#0f172a",
              0.94
            )} 100%)`,
          }}
        >
          <Box className="p-5">
            <Stack direction="row" spacing={2} alignItems="center">
              <Box
                sx={{
                  ...
                  boxShadow: `0 18px 40px ${alpha("#0ea5e9", 0.24)}`,
                }}
              >
                <img
              ...
              <Box>
                <Typography sx={{ fontSize: 24, fontWeight: 800, color: "#f8fafc" }}>
                  Dummi X
                </Typography>
                <Typography sx={{ fontSize: 12, color: "rgba(224,242,254,0.76)" }}>
            ...
            >
              ...
              <Typography sx={{ mt: 1, color: "rgba(226,232,240,0.76)", lineHeight: 1.7 }}>
                {activeMode.blurb}
              </Typography>
            </Paper>
        ...
        >
          <Box
            className="border-b border-white/10 px-4 py-3 sm:px-5"
            sx={{ bgcolor: alpha("#020617", 0.44) }}
          >
            <Box className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <Box className="min-w-0">
                <Typography sx={{ fontSize: { xs: 22, sm: 24 }, fontWeight: 800, color: "#f8fafc" }}>
                  Real-Time AI Mentor Assistance
                </Typography>
                <Typography sx={{ mt: 0.25, color: "rgba(226,232,240,0.74)", fontSize: 14 }}>
                  ...
                  return (
                    <Button
                      ...
                      variant={active ? "contained" : "outlined"}
                        ...
                        background: active
                          ? "linear-gradient(135deg, #67e8f9 0%, #34d399 100%)"
                          : alpha("#ffffff", 0.03),
                      }}
                    >
                      {item.label}
          ...
          >
            ...
            >
              <Box
                className="overflow-y-auto px-4 py-4 sm:px-5"
                ref={chatContainerRef}
                onScroll={syncScrollLock}
                sx={{
                  background:
                    "linear-gradient(180deg, rgba(8,47,73,0.06) 0%, rgba(15,23,42,0.24) 100%)",
                }}
              >
                {!isQuizMode && error ? (
                  <Paper
                ...
                {isQuizMode ? (
                  ...
                  <Box className="flex h-full items-center justify-center">
                    <Paper
                      elevation={0}
                      className="w-full max-w-2xl rounded-[30px] border border-white/10 px-6 py-8 text-center"
                      sx={{
                        bgcolor: alpha("#0f172a", 0.7),
                        boxShadow: `0 24px 70px ${alpha("#020617", 0.24)}`,
                      }}
                    >
                      <Avatar
                        sx={{
                      ...
                      <Typography sx={{ fontSize: 30, fontWeight: 800, color: "#f8fafc" }}>
                          ...
                          >
                            <Avatar
                              sx={{
                                width: 42,
                                height: 42,
                                bgcolor: isUser ? alpha("#2563eb", 0.18) : alpha("#34d399", 0.16),
                                color: isUser ? "#bfdbfe" : "#d1fae5",
                              }}
                            >
                            ...
                            <Paper
                              ...
                              sx={{
                                ...
                                borderRadius: isUser
                                  ? "22px 22px 8px 22px"
                                  : "22px 22px 22px 8px",
                                bgcolor: isUser ? "#0f766e" : alpha("#0f172a", 0.9),
                                color: "#f8fafc",
                                border: `1px solid ${
                                  isUser ? alpha("#99f6e4", 0.15) : alpha("#67e8f9", 0.12)
                                }`,
                                boxShadow: `0 18px 46px ${alpha("#020617", 0.18)}`,
                                whiteSpace: "pre-wrap",
                                lineHeight: 1.8,
                              }}
                            >
              ...
              >
                <Box className="flex flex-wrap items-center gap-3">
                  ...
                  {isQuizMode ? (
                    <Typography sx={{ color: "rgba(226,232,240,0.68)", fontSize: 13 }}>
                      Quiz mode is interactive. Use the question grid, move with Previous and Next,
                      then submit to review green correct answers and red wrong selections.
                    </Typography>
                  ) : (
                    <>
                      <Button
        ...
        <Box
          className="hidden min-h-0 overflow-y-auto border-l border-white/10 p-4 xl:block"
          sx={{
            bgcolor: alpha("#082f49", 0.28),
          }}
        >
              <Paper
                elevation={0}
              ...
              >
                <Box
                  sx={{
                    ...
                    boxShadow: `0 18px 40px ${alpha("#0ea5e9", 0.18)}`,
                  }}
                >
                  <img
                    src="/models/mentor.jpg"
